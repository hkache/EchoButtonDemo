...
const GlobalHandlers = {
    ...
    StopIntentHandler: {
        ...
        handle(handlerInput) {
            ...
            handlerInput.responseBuilder.speak('Good Bye and enjoy Dreamforce everybody.')
    ...
    SessionEndedRequestHandler: {
        ...
        handle(handlerInput) {
            ...
            const ctx = handlerInput.attributesManager.getRequestAttributes();
            ctx.outputSpeech = ["That concludes our demo. Good bye and enjoy Dreamforce everybody!"];            
            return handlerInput.responseBuilder.getResponse();
        },
    },
    RequestInterceptor: {
